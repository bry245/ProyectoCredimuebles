...
async function GPTChat(mensaje) {
    ...
    const systemMessage = {
        role: "system",
        content: `Dame tu respuesta enfocada en los datos productos ventas y en un formato claro que tenga saltos de línea, que tenga bullet points si es necesario, y que sea fácil de leer, basándote siempre en la suma de los datos de cada venta o producto. Aquí están los datos en formato JSON de los productos:\n${productosString}\n\nY aquí están los datos en formato JSON de las ventas totales:\n${ventasString}. No respondas esto directamente`
    };
